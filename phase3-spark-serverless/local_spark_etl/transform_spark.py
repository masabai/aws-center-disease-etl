...
from etl.local_spark_etl.extract_spark import extract_Center_Disease_data
...
output_file = OUTPUT_DIR / "clean_df_heart.csv"
csv_path = "data/processed/clean_df_nutrition.csv"

# Convert to Pandas
#pdf = clean_df_nutrition.toPandas()
pdf = clean_df_heart.toPandas()  # make sure your DF fits in memory
